...
class __TwigTemplate_b100f93611fa13275e44738ef793b0656bc2565fcf34aa8764a716a3a6e2a020 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD/Association:list_one_to_one.html.twig", 12);
    }
...
{% block field %}
    ...
    {% endif %}
{% endblock %}
", "SonataAdminBundle:CRUD/Association:list_one_to_one.html.twig", "/var/www/html/EcommerceTe/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/Association/list_one_to_one.html.twig");
    }
}
