...
class __TwigTemplate_dba15f9b7f9ac35cccca4e9a0ed0bde4fbe06c2ab703e492cfc566f17c2bed12 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_url.html.twig", 12);
    }
...
{% endspaceless %}
{% endblock %}
", "SonataAdminBundle:CRUD:list_url.html.twig", "/var/www/html/EcommerceTe/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_url.html.twig");
    }
}
