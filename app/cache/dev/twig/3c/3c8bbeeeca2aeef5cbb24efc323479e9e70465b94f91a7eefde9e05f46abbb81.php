...
class __TwigTemplate_224d00f7a3e4086cac7712e874dd094f060097321668537117a0d49037ab6b06 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_trans.html.twig", 12);
    }
...
{% endblock %}
", "SonataAdminBundle:CRUD:list_trans.html.twig", "/var/www/html/UserDemo/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_trans.html.twig");
    }
}
