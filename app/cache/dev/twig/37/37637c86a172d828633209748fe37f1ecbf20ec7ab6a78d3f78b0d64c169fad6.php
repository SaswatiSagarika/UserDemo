...
class __TwigTemplate_577492c7d9bfca06d181ffff0cb449c31ec925e3c2d1c75f3d0ebf6a1cdc2bd7 extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_html.html.twig", 1);
    }
...
{% block field %}
    ...
    {% endif %}
{% endblock %}
", "SonataAdminBundle:CRUD:list_html.html.twig", "/var/www/html/EcommerceTe/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_html.html.twig");
    }
}
